...
If doctor reports usable worker status, open the agent:
...
```text
No .swain/profile.yaml found. Run swain init or swain scan first.
```
...
```bash
swain init /path/to/your/repo --no-llm
```
